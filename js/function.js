...
function photoModalCancel(modal) {
  ...
  if(modal === 'Modal1') {
    ...
    if(document.querySelector("#envirPhotoModal1 #titleText") !== null) {
      document.querySelector("#envirPhotoModal1 #titleText").innerHTML = [settingPhoto?.aroundSetting?.preTestPhoto.length] + ". During the session";
    }
    ...
    if(document.querySelector("#envirPhotoModal2 #titleText") !== null) {
      document.querySelector("#envirPhotoModal2 #titleText").innerHTML = settingPhoto?.aroundSetting?.reactivateTestPhotos.length + ". During the session";
    }
    ...
    if(document.querySelector("#cameraPhotoModal1 #titleText") !== null) {
      document.querySelector("#cameraPhotoModal1 #titleText").innerHTML = [settingPhoto?.cameraSetting?.preTestPhoto.length] + ". During the session";
    }
    ...
    if(document.querySelector("#cameraPhotoModal2 #titleText") !== null) {
      document.querySelector("#cameraPhotoModal2 #titleText").innerHTML = settingPhoto?.cameraSetting?.reactivateTestPhotos.length + ". During the session";
    }
...
function photoModalPageNation(direction, element, photos) {
  ...
  titleBox.childNodes[2].innerHTML = arr.length - nowPhotoNumber + 1 + ". During the session";
